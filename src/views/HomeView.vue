<template>
  <section>
    <el-card shadow="never" class="relative h-80 w-full max-w-xl" :body-style="{ padding: 0 }">
      <img
        ...
        alt="work img" class="block" />
      <a href="#" class="absolute top-0 left-0 flex w-full h-full decoration-none text-[#333]">
        <div style="
